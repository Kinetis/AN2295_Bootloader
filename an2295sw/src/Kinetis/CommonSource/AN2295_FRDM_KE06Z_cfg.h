...
//Register
  ...
  #define FLASH_INIT_FLASH_CLOCK        FTMRE_FCLKDIV = 0x93;//SIM_CLKDIV1 |= SIM_CLKDIV1_OUTDIV4(2);
  #define FLASH_BASE_PTR                FTMRE_BASE_PTR
  #define FLASH_FSTAT                   FTMRE_FSTAT                                  
  #define FLASH_FSTAT_CCIF_MASK         FTMRE_FSTAT_CCIF_MASK
  #define FLASH_FSTAT_ACCERR_MASK       FTMRE_FSTAT_ACCERR_MASK
  #define FLASH_FSTAT_FPVIOL_MASK       FTMRE_FSTAT_FPVIOL_MASK
