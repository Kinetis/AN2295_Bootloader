...
**
**     Abstract:
**         This header file implements peripheral memory map for MKL43Z4
**         processor.
**
 ...
 * @version 1.3
 * @date 2014-08-21
 * @brief Peripheral memory map for MKL43Z4
 *
 * This header file implements peripheral memory map for MKL43Z4 processor.
 */
...
#if !defined(MCU_MKL43Z4)  /* Check if memory map has not been already included */
#define MCU_MKL43Z4
...
typedef enum {
  ...
  INT_LPUART1                  = 29,               /**< LPUART1 status and error */
  INT_UART2_FLEXIO             = 30,               /**< UART2 or FLEXIO */
  ...
  INT_LCD                      = 45,               /**< LCD interrupt */
  INT_PORTA                    = 46,               /**< PORTA Pin detect */
  INT_PORTCD                   = 47                /**< Single interrupt vector for PORTC; PORTD Pin detect */
} IRQInterruptIndex;
...
typedef struct FLEXIO_MemMap {
  ...
  uint32_t SHIFTBUFBBS[4];                         /**< Shifter Buffer N Bit Byte Swapped Register, array offset: 0x280, array step: 0x4 */
  uint8_t RESERVED_7[112];
  uint32_t SHIFTBUFBYS[4];                         /**< Shifter Buffer N Byte Swapped Register, array offset: 0x300, array step: 0x4 */
  uint8_t RESERVED_8[112];
  uint32_t SHIFTBUFBIS[4];                         /**< Shifter Buffer N Bit Swapped Register, array offset: 0x380, array step: 0x4 */
...
#define FLEXIO_BASE_PTR                          ((FLEXIO_MemMapPtr)0x4005F000u)
/** Array initializer of FLEXIO peripheral base pointers */
#define FLEXIO_BASE_PTRS                         { FLEXIO_BASE_PTR }
...
/* FLEXIO */
#define FLEXIO_VERID                             FLEXIO_VERID_REG(FLEXIO_BASE_PTR)
#define FLEXIO_PARAM                             FLEXIO_PARAM_REG(FLEXIO_BASE_PTR)
#define FLEXIO_CTRL                              FLEXIO_CTRL_REG(FLEXIO_BASE_PTR)
#define FLEXIO_SHIFTSTAT                         FLEXIO_SHIFTSTAT_REG(FLEXIO_BASE_PTR)
#define FLEXIO_SHIFTERR                          FLEXIO_SHIFTERR_REG(FLEXIO_BASE_PTR)
#define FLEXIO_TIMSTAT                           FLEXIO_TIMSTAT_REG(FLEXIO_BASE_PTR)
#define FLEXIO_SHIFTSIEN                         FLEXIO_SHIFTSIEN_REG(FLEXIO_BASE_PTR)
#define FLEXIO_SHIFTEIEN                         FLEXIO_SHIFTEIEN_REG(FLEXIO_BASE_PTR)
#define FLEXIO_TIMIEN                            FLEXIO_TIMIEN_REG(FLEXIO_BASE_PTR)
#define FLEXIO_SHIFTSDEN                         FLEXIO_SHIFTSDEN_REG(FLEXIO_BASE_PTR)
#define FLEXIO_SHIFTCTL0                         FLEXIO_SHIFTCTL_REG(FLEXIO_BASE_PTR,0)
#define FLEXIO_SHIFTCTL1                         FLEXIO_SHIFTCTL_REG(FLEXIO_BASE_PTR,1)
#define FLEXIO_SHIFTCTL2                         FLEXIO_SHIFTCTL_REG(FLEXIO_BASE_PTR,2)
#define FLEXIO_SHIFTCTL3                         FLEXIO_SHIFTCTL_REG(FLEXIO_BASE_PTR,3)
#define FLEXIO_SHIFTCFG0                         FLEXIO_SHIFTCFG_REG(FLEXIO_BASE_PTR,0)
#define FLEXIO_SHIFTCFG1                         FLEXIO_SHIFTCFG_REG(FLEXIO_BASE_PTR,1)
#define FLEXIO_SHIFTCFG2                         FLEXIO_SHIFTCFG_REG(FLEXIO_BASE_PTR,2)
#define FLEXIO_SHIFTCFG3                         FLEXIO_SHIFTCFG_REG(FLEXIO_BASE_PTR,3)
#define FLEXIO_SHIFTBUF0                         FLEXIO_SHIFTBUF_REG(FLEXIO_BASE_PTR,0)
#define FLEXIO_SHIFTBUF1                         FLEXIO_SHIFTBUF_REG(FLEXIO_BASE_PTR,1)
#define FLEXIO_SHIFTBUF2                         FLEXIO_SHIFTBUF_REG(FLEXIO_BASE_PTR,2)
#define FLEXIO_SHIFTBUF3                         FLEXIO_SHIFTBUF_REG(FLEXIO_BASE_PTR,3)
#define FLEXIO_SHIFTBUFBBS0                      FLEXIO_SHIFTBUFBBS_REG(FLEXIO_BASE_PTR,0)
#define FLEXIO_SHIFTBUFBBS1                      FLEXIO_SHIFTBUFBBS_REG(FLEXIO_BASE_PTR,1)
#define FLEXIO_SHIFTBUFBBS2                      FLEXIO_SHIFTBUFBBS_REG(FLEXIO_BASE_PTR,2)
#define FLEXIO_SHIFTBUFBBS3                      FLEXIO_SHIFTBUFBBS_REG(FLEXIO_BASE_PTR,3)
#define FLEXIO_SHIFTBUFBYS0                      FLEXIO_SHIFTBUFBYS_REG(FLEXIO_BASE_PTR,0)
#define FLEXIO_SHIFTBUFBYS1                      FLEXIO_SHIFTBUFBYS_REG(FLEXIO_BASE_PTR,1)
#define FLEXIO_SHIFTBUFBYS2                      FLEXIO_SHIFTBUFBYS_REG(FLEXIO_BASE_PTR,2)
#define FLEXIO_SHIFTBUFBYS3                      FLEXIO_SHIFTBUFBYS_REG(FLEXIO_BASE_PTR,3)
#define FLEXIO_SHIFTBUFBIS0                      FLEXIO_SHIFTBUFBIS_REG(FLEXIO_BASE_PTR,0)
#define FLEXIO_SHIFTBUFBIS1                      FLEXIO_SHIFTBUFBIS_REG(FLEXIO_BASE_PTR,1)
#define FLEXIO_SHIFTBUFBIS2                      FLEXIO_SHIFTBUFBIS_REG(FLEXIO_BASE_PTR,2)
#define FLEXIO_SHIFTBUFBIS3                      FLEXIO_SHIFTBUFBIS_REG(FLEXIO_BASE_PTR,3)
#define FLEXIO_TIMCTL0                           FLEXIO_TIMCTL_REG(FLEXIO_BASE_PTR,0)
#define FLEXIO_TIMCTL1                           FLEXIO_TIMCTL_REG(FLEXIO_BASE_PTR,1)
#define FLEXIO_TIMCTL2                           FLEXIO_TIMCTL_REG(FLEXIO_BASE_PTR,2)
#define FLEXIO_TIMCTL3                           FLEXIO_TIMCTL_REG(FLEXIO_BASE_PTR,3)
#define FLEXIO_TIMCFG0                           FLEXIO_TIMCFG_REG(FLEXIO_BASE_PTR,0)
#define FLEXIO_TIMCFG1                           FLEXIO_TIMCFG_REG(FLEXIO_BASE_PTR,1)
#define FLEXIO_TIMCFG2                           FLEXIO_TIMCFG_REG(FLEXIO_BASE_PTR,2)
#define FLEXIO_TIMCFG3                           FLEXIO_TIMCFG_REG(FLEXIO_BASE_PTR,3)
#define FLEXIO_TIMCMP0                           FLEXIO_TIMCMP_REG(FLEXIO_BASE_PTR,0)
#define FLEXIO_TIMCMP1                           FLEXIO_TIMCMP_REG(FLEXIO_BASE_PTR,1)
#define FLEXIO_TIMCMP2                           FLEXIO_TIMCMP_REG(FLEXIO_BASE_PTR,2)
#define FLEXIO_TIMCMP3                           FLEXIO_TIMCMP_REG(FLEXIO_BASE_PTR,3)

/* FLEXIO - Register array accessors */
#define FLEXIO_SHIFTCTL(index)                   FLEXIO_SHIFTCTL_REG(FLEXIO_BASE_PTR,index)
#define FLEXIO_SHIFTCFG(index)                   FLEXIO_SHIFTCFG_REG(FLEXIO_BASE_PTR,index)
#define FLEXIO_SHIFTBUF(index)                   FLEXIO_SHIFTBUF_REG(FLEXIO_BASE_PTR,index)
#define FLEXIO_SHIFTBUFBBS(index)                FLEXIO_SHIFTBUFBBS_REG(FLEXIO_BASE_PTR,index)
#define FLEXIO_SHIFTBUFBYS(index)                FLEXIO_SHIFTBUFBYS_REG(FLEXIO_BASE_PTR,index)
#define FLEXIO_SHIFTBUFBIS(index)                FLEXIO_SHIFTBUFBIS_REG(FLEXIO_BASE_PTR,index)
#define FLEXIO_TIMCTL(index)                     FLEXIO_TIMCTL_REG(FLEXIO_BASE_PTR,index)
#define FLEXIO_TIMCFG(index)                     FLEXIO_TIMCFG_REG(FLEXIO_BASE_PTR,index)
#define FLEXIO_TIMCMP(index)                     FLEXIO_TIMCMP_REG(FLEXIO_BASE_PTR,index)
...
#define LPUART1_BASE_PTR                         ((LPUART_MemMapPtr)0x40055000u)
/** Array initializer of LPUART peripheral base pointers */
#define LPUART_BASE_PTRS                         { LPUART0_BASE_PTR, LPUART1_BASE_PTR }
...
typedef struct MCG_MemMap {
  ...
  uint8_t HTTRIM;                                  /**< MCG High-frequency IRC Tempco (Temperature Coefficient) Trim Register, offset: 0x15 */
...
#define UART_BASE_PTRS                           { UART2_BASE_PTR }
...
#define UART2_WP7816                             UART_WP7816_REG(UART2_BASE_PTR)
...
#define UART2_AP7816A_T0                         UART_AP7816A_T0_REG(UART2_BASE_PTR)
#define UART2_AP7816B_T0                         UART_AP7816B_T0_REG(UART2_BASE_PTR)
#define UART2_WP7816A_T0                         UART_WP7816A_T0_REG(UART2_BASE_PTR)
#define UART2_WP7816A_T1                         UART_WP7816A_T1_REG(UART2_BASE_PTR)
#define UART2_WP7816B_T0                         UART_WP7816B_T0_REG(UART2_BASE_PTR)
#define UART2_WP7816B_T1                         UART_WP7816B_T1_REG(UART2_BASE_PTR)
#define UART2_WGP7816_T1                         UART_WGP7816_T1_REG(UART2_BASE_PTR)
#define UART2_WP7816C_T1                         UART_WP7816C_T1_REG(UART2_BASE_PTR)
...
typedef struct USB_MemMap {
  ...
  uint8_t CTL0;                                    /**< Control register, offset: 0x1C */
  ...
  uint8_t CTL1;                                    /**< Control register, offset: 0x94 */
...
#define USB0_CTL0                                USB_CTL0_REG(USB0_BASE_PTR)
...
#define USB0_CTL1                                USB_CTL1_REG(USB0_BASE_PTR)
...
#define INT_UART0_FLEXIO                       INT_UART2_FLEXIO
