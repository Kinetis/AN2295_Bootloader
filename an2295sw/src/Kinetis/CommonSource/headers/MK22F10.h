...
**
**     Reference manual:    K22P144M100SF5RM Rev. 0, May 2012
**     Version:             rev. 1.0, 2012-06-06
**
**     Abstract:
**         This header file implements peripheral memory map for MK22F10
**         processor.
**
 ...
 * @version 1.0.1.0
 * @date Dec-19-2012
 * @brief Peripheral memory map for MK22F10
 *
 * This header file implements peripheral memory map for MK22F10 processor.
 */
...
#if !defined(MCU_MK22F10)  /* Check if memory map has not been already included */
#define MCU_MK22F10

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MK22F10 memory map: There is already included another memory map. Only one memory map can be included.
...
typedef enum {
  ...
  INT_CMP1                     = 57,               /**< Reserved interrupt 57 */
...
typedef struct SIM_MemMap {
  ...
  uint8_t RESERVED_3[8]; // changed to 8
  uint32_t SDID;    // added                       /**< System Device Identification Register, offset: 0x1024 */
