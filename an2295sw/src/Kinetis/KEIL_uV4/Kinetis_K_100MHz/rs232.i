#line 1 "..\\CommonSource\\rs232\\rs232.c"
...
#line 17 "..\\CommonSource\\rs232\\rs232.c"
...
#line 18 "..\\CommonSource\\rs232\\rs232.c"
...
#line 19 "..\\CommonSource\\rs232\\rs232.c"
...
void UART_Initialization(void)
{
  ((((UART_MemMapPtr)0x400EB000u))->BDH)     = (((unsigned char)((48000000) / (16*115200))>>8)&0x1f);
  ((((UART_MemMapPtr)0x400EB000u))->BDL)     = ((unsigned char)((48000000) / (16*115200))&0xff);

  ((((UART_MemMapPtr)0x400EB000u))->C4)      = ((unsigned char)(((((48000000)/(16*115200))- (unsigned char)((48000000) / (16*115200)))*32.0)+0.5)&0x1f);  

  ((((UART_MemMapPtr)0x400EB000u))->C2)      = 0x8u|0x4u;

  while((((((UART_MemMapPtr)0x400EB000u))->S1) & 0x20u))
    (void)UART_GetChar();
}
...
void UART_PutChar(unsigned char data)
{
  while((((((UART_MemMapPtr)0x400EB000u))->S1)&0x40u) == 0){};
  ((((UART_MemMapPtr)0x400EB000u))->D) = data;
}
...
unsigned char UART_GetChar(void)
{
  while((((((UART_MemMapPtr)0x400EB000u))->S1) & 0x20u) == 0){
  ...
  return ((((UART_MemMapPtr)0x400EB000u))->D);
}
