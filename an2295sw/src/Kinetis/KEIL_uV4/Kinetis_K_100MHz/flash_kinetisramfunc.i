#line 1 "..\\CommonSource\\flash\\flash_kinetisRamFunc.c"
...
#line 17 "..\\CommonSource\\flash\\flash_kinetisRamFunc.c"
...
#line 18 "..\\CommonSource\\flash\\flash_kinetisRamFunc.c"
...
#line 118 "..\\CommonSource\\flash\\flash_kinetisRamFunc.c"

LWord FLASH_FlashCommandSequenceStart(Byte index)
{
  Byte* ptrFccobReg = (Byte*)&((FTFL_MemMapPtr)0x40020000u)->FCCOB3;
  Byte* ptrCommandObj = (Byte*)&CommandObj;

   
  while(!(((((FTFL_MemMapPtr)0x40020000u))->FSTAT) & 0x80u)){};
  ...
  return (((((FTFL_MemMapPtr)0x40020000u))->FSTAT) & (0x20u | 0x10u | 0x1u));  
} 
