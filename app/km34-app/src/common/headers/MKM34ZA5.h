...
**
**     Abstract:
**         This header file implements peripheral memory map for MKM34ZA5
**         processor.
**
 ...
 * @version 1.0
 * @date 2014-07-22
 * @brief Peripheral memory map for MKM34ZA5
 *
 * This header file implements peripheral memory map for MKM34ZA5 processor.
 */
...
#if !defined(MCU_MKM34ZA5)  /* Check if memory map has not been already included */
#define MCU_MKM34ZA5
