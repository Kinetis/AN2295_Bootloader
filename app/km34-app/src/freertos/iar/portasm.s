...
pendsv_isr:
  ...
  ldr r1,=0xe000e180  	/* clear syscall interrupts by writing configSYSCALL_INTERRUPT_MASK to NVIC_ICER */ 
  ldr r0,=configSYSCALL_INTERRUPT_MASK
  str r0,[r1]
        
	bl vTaskSwitchContext
	
  ldr r1,=0xe000e100  	/* set syscall interrupts by writing configSYSCALL_INTERRUPT_MASK to NVIC_ISER */
  ldr r0,=configSYSCALL_INTERRUPT_MASK
  str r0,[r1]
