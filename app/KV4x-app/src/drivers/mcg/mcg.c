...
int pll_init(int crystal_val, unsigned char hgo_val, unsigned char erefs_val, signed char prdiv_val, signed char vdiv_val, unsigned char mcgout_select)
{
  ...
  if ((prdiv_val < 1) || (prdiv_val > 18)) {return 0x41;}
  ...
  pll_freq = ((crystal_val / prdiv_val) * vdiv_val)/2;
  if ((pll_freq < 48000000) || (pll_freq > 100000000)) {return 0x45;}
  //For K60_1M
  if ((pll_freq < 18000000) || (pll_freq > 360000000)) {return 0x45;}
...
//  temp_reg |= MCG_C5_PRDIV0(prdiv_val - 1);    //set PLL ref divider
  ...
  temp_reg |= MCG_C5_PLLCLKEN_MASK | MCG_C5_PRDIV(prdiv_val - 1);    //set PLL ref divider
  MCG_C5 = temp_reg;
...
//  vdiv = ((MCG_C6 & MCG_C6_VDIV0_MASK) + 24);
  ...
  return (((crystal_val / prdiv) * vdiv)/2); //MCGOUT equals PLL output frequency
} // pll_init
...
////For K60_1M, make RTC as FLL reference
//    MCG_C7 |=  MCG_C7_OSCSEL(1) ;//RTC oscillator as reference
// 
